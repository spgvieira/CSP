 ...
 */
 ...
 // JAVA NAOT #3
 // https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/fannkuchredux-graalvmaot-3.html

public final class ImperativeParallelSpectralNorm implements Runnable{
	...
	NTASKS = (Fact[n] + CHUNKSZ - 1) / CHUNKSZ;
        ...
        for ( int i=0; i<nthreads; ++i ) {
            threads[i] = new Thread( new ImperativeParallelSpectralNorm() );
            threads[i].start();
        }
